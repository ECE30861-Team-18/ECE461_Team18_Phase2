...
const API_BASE_URL =
  "https://wc1j5prmsj.execute-api.us-east-1.amazonaws.com/dev";
...
class ApiClient {
  ...
  async getArtifactCost(
    ...
    return this.request<ArtifactCost>(`/artifact/${type}/${id}/cost${params}`);
  }
  ...
  async getArtifactAudit(
    ...
    return this.request<ArtifactAuditEntry[]>(`/artifact/${type}/${id}/audit`);
  }
